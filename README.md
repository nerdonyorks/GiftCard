...
A simple festive “gift card / greeting card” web page — a playful interactive way to send holiday wishes.  
...
- No build tools or dependencies — just plain web technologies  

## 🚀 How to Use / View the Project  
Because this is a static webpage, you can open it directly in a browser.  
